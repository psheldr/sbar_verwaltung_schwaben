...
///////////////
            ...
            $log = date("d.m.Y H:i:s") . ';' . $laufzeit . ';Zahlen für ' . $import_ct . ' S-Bar Kunden importiert' . PHP_EOL;
            file_put_contents('/is/htdocs/wp1055935_1F55KTNHIC/www/sbar/verwaltung_schwaben/logs/last_kf_import.log', $log);  /**/
...
<?php if ($refresh_page) { ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () { });
            window.location.replace("https://www.s-bar.net/verwaltung_schwaben/index.php?action=cockpit&cat=kitafino&kids=<?php echo $kitafino_ids ?>");
