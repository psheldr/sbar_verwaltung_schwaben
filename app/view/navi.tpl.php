...
<table class="navi_tbl" border="0" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td>
         ...
         <?php } ?>
        <?php if ($_SESSION['logged_in_recht'] <= 2 || $_SESSION['logged_in_user_id'] == 4 || $_SESSION['logged_in_recht'] == 4 ) { ?>
        <td>
         ...
         <?php } ?>
        <?php if ($_SESSION['logged_in_recht'] <= 2) { ?>
        <td>
        ...
        <?php if ($_SESSION['logged_in_recht'] <= 2 || $_SESSION['logged_in_recht'] == 5) { ?>
        <td>
    ...
    <tr>
        ...
        <?php if ($_SESSION['logged_in_recht'] <= 4) { ?>
        <td>
            <a href="index.php?action=traeger" <?php if($action == 'traeger') {echo 'class="active_navi"';} ?>>Trägerverwaltung</a>
        </td>
...
&nbsp;&nbsp;<a  href="index.php?action=log_out" <?php if($action == 'log_out') {echo 'class="active_navi"';} ?>>abmelden >></a>
    ...
    <p style="font-size: 16px; font-weight: bold;">Schwabenmenü</p>