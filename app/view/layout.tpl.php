                    ...
                    $(function () {
                        $("#list ul").sortable({
                            ...
                            update: function (event, ui) {
                                if (ui.item.data('kat') == 5 && ui.item.next().hasClass('einrichtung_item')) {
                                    alert('Komplette Touren, dürfen nur vor einer anderen Tour platziert werden');

                                    $(this).sortable("cancel");
                                    return false;
                                }
                                var order = $(this).sortable("serialize") + '&update=update&kat=' + ui.item.data('kat') + '&movedid=' + ui.item.data('movedid');
                                $.post("updateList.php", order, function (theResponse) {
                                    ...
                                    window.location.href = '#anchor_' + ui.item.data('movedid');
