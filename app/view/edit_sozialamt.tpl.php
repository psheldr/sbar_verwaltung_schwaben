...
<?php if (!$neues_amt->istValide()) { ?>
            ...
            <label class="form_label" for="">Bezeichnung*</label>
                <input class="form_input" type="text" name="bezeichnung"  value="<?php echo $neues_amt->getBezeichnung() ?>" />
       <br />
        ...
        <textarea class="" name="notiz" cols="8" rows="6" ><?php echo br2nl($neues_amt->getNotiz()) ?></textarea>
<br />
