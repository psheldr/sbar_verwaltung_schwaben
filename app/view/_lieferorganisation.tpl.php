...
<div id="container">
    <div id="list">
        ...
        <ul>
            <?php
            include("connect.php");
            $query  = "SELECT id, name, essenszeit, lieferreihenfolge, einrichtungskategorie_id, staedtischer_kunde, bio_kunde FROM kunde WHERE aktiv = 1 ORDER BY lieferreihenfolge ASC";
